...
if(isset($_POST['submit'])){
  ...
  $result = mysqli_query($conexao, "INSERT INTO usuarios(nome, usuario, email, senha) VALUES ('$nome', '$usuario', '$email', '$senha')");
  ...
  <div class="container">
    <div class="left-login">
      ...
      <div class="middle-left-login">
        <h1>Create your Riot <span>Account</span></h1>
        ...
        <div class="card-login">
          <form action="cadastro.php" method="post">
            ...
            <div class="button-form">
              <input type="submit" name="submit" value="Finish" id="submit" />
              <a href="../index.php">
                <i class="bi bi-arrow-left-short" style="color: lightgray; font-size: 25px"></i>
              </a>
            </div>
          </form>
        </div>
